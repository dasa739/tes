	...
	<div class="tokyo_tm_all_wrap" data-magic-cursor="show" data-enter="fadeInUp" data-exit=""> 
		...
		<div class="leftpart">
			<div class="leftpart_inner">
				...
				<div class="copyright">
					<p>&copy; 2022 Dafa<br>Created by <a href="https://themeforest.net/user/marketify" target="_blank">Marketify</a></p>
				</div>
			</div>
		</div>
		<!-- /LEFTPART -->
					...
					<div class="container">
						<div class="tokyo_tm_home">
							<div class="home_content">
								...
								<div class="details">
									<h3 class="name">Muhamad <span>Dafa</span></h3>
									<p class="job">Saya Muhamad Dafa Satria Sidik Mahasiswa di Universitas Muhammadiyah Sukabumi saya tertarik pada Front-End Web Development dan Project Management</p>
									<div class="social">
										<ul>
											<li><a href="https://www.linkedin.com/in/dafa-satria-70b960243/"><i class="icon-linkedin-squared"></i></a></li>
											</ul>
									</div>
								</div>
							</div>
					...
					<div class="container">
						<div class="tokyo_tm_about">
							...
							<div class="about_title">
								<h3>Muhamad Dafa Satria Sidik</h3>
								<span>Web Front-End dan Mahasiswa</span>
							</div>
							<div class="about_text">
								<p>Halo. Saya Muhamad Dafa Satria Sidik saya seorang mahasiswa yang tertarik pada Front-End Web Development dan Project Management</p>
								<p>Hobi saya banyak seperti baca Novel, nonton Anime, Series dan Movie, saya cukup pandai berkomunikas dan tertarik dalam kreatif.</p>
							</div>
							<div class="tokyo_tm_short_info">
								<div class="left">
									<div class="tokyo_tm_info">
										<ul>
											<li><span>TTL:</span><span>01-April-2002</span></li>
											<li><span>Umur:</span><span>21</span></li>
											<li><span>Alamat:</span><span>Jalan Selabintana, Sukabumi</span></li>
											<li><span>Email:</span><span>dafasatria379@gmail.com</span></li>
											<li><span>Phone:</span><span>08812080768</span></li>
										</ul>
									</div>
								</div>
								<div class="right">
									<div class="tokyo_tm_info">
										<ul>
											<li><span>Universitas:</span><span>Muhammadiyah Kota Sukabumi</span></li>
											<li><span>Lulusan:</span><span>SMK</span></li>
					...
					<div class="tokyo_tm_progressbox">
						<div class="container">
							<div class="in">
								<div class="left">
									...
									<div class="tokyo_progress">
										...
										<div class="progress_inner" data-value="50" >
											<span><span class="label">JavaScript</span><span class="number">50%</span></span>
											<div class="background"><div class="bar"><div class="bar_in"></div></div></div>
										</div>
										<div class="progress_inner" data-value="80">
											<span><span class="label">CSS</span><span class="number">80%</span></span>
											<div class="background"><div class="bar"><div class="bar_in"></div></div></div>
										</div>
									</div>
								</div>
								<div class="right">
									<div class="tokyo_section_title">
										<h3>Kemampuan Berbahasa</h3>
									</div>
									<div class="tokyo_progress">
										<div class="progress_inner" data-value="70">
											<span><span class="label">English</span><span class="number">70%</span></span>
											<div class="background"><div class="bar"><div class="bar_in"></div></div></div>
										</div>
										<div class="progress_inner" data-value="90" >
											<span><span class="label">Indonesia</span><span class="number">90%</span></span>
											<div class="background"><div class="bar"><div class="bar_in"></div></div></div>
										</div>
									</div>
								</div>
									...
									<div class="tokyo_tm_resume_list">
										<ul>
											<li>
												<div class="list_inner">
													<div class="time">
														<span>2019 (5 Bulan</span>
													</div>
													<div class="place">
														<h3>CV Almindo Pratama</h3>
														<span>Front-End Web dan Tester</span>
													</div>
												</div>
											</li>
											<li>
												<div class="list_inner">
													<div class="time">
														<span>2022 (6 Bulan)</span>
													</div>
													<div class="place">
														<h3>Dicoding MSIB</h3>
														<span>Front-End Web Development and React</span>
													</div>
												</div>
											</li>
										</ul>
